    ...
    switch(c_mem.control_mode) {
        ...
        case DEFLECTION_CONTROL:
            ...
            if(c_mem.control_mode == DEFLECTION_CONTROL){
                ...
                // position error
                pos_error = g_ref.pos[index] - g_meas.pos[index]; //g_ref.pos[index] 
...
void encoder_reading(const uint8 idx)
{
    ...
    //Shift right 1 bit to erase dummy bit of chain   
    switch(index) {
        case 0:
        ...
        case 3:
            ...
            break;
        case 4:
            data_encoder = (SHIFTREG_ENC_5_ReadData() >> 1) & 0x3FFFF;
            break;
        case 5:
            data_encoder = (SHIFTREG_ENC_6_ReadData() >> 1) & 0x3FFFF;
            break;
    }
    ...
    if(check_enc_data(&data_encoder)) {
        ...
        value_encoder = (int32) (((data_encoder & 0x3FFC0) - 0x20000) >> 2);
