...
port_label( 'output', 1, 'enc_1' );
port_label( 'output', 2, 'enc_2' );
port_label( 'output', 3, 'enc_3' );
port_label( 'output', 4, 'enc_4' );
port_label( 'output', 5, 'enc_5' );
port_label( 'output', 6, 'enc_6' );
